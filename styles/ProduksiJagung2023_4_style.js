...
var style_ProduksiJagung2023_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Produksi Jagung(ton)_2023");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 22770.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22770.000000 && value <= 57785.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 57785.000000 && value <= 135112.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 135112.000000 && value <= 291661.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 291661.000000 && value <= 745651.000000) {
            style = [ new ol.style.Style({
