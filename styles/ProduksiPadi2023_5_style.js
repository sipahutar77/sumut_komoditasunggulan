...
var style_ProduksiPadi2023_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Produksi Padi(ton)_2023");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 21310.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21310.000000 && value <= 48694.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 48694.000000 && value <= 91189.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 91189.000000 && value <= 143824.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 143824.000000 && value <= 312406.000000) {
            style = [ new ol.style.Style({
